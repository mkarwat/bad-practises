from pi_functions import PiContainer, approximate_pi
...
def main():
    my_pi = PiContainer()
    pi_gen = approximate_pi(approx_level=5)
    ...
    pi_gen = approximate_pi(approx_level=194)
    my_pi_2 = PiContainer()
    ...
    my_pi_3 = PiContainer()
    pi_gen = approximate_pi(approx_level=60)
    ...
    base_path = Path(r'./')
    file_name = 'pi_approximation.txt'
